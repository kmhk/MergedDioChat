...
NSString *const kLinphoneMsgNotificationAppGroupId = @"group.sip.tribu.ios.msgNotification";
...
- (void)createLinphoneCore {
	...
	NSString *ring =
		([LinphoneManager bundleFile:[self lpConfigStringForKey:@"local_ring" inSection:@"sound"].lastPathComponent]
		 ?: [LinphoneManager bundleFile:@"peek_door_quest.caf"])
		.lastPathComponent;
	NSString *ringback =
...
- (void)setPushKitToken:(NSData *)pushKitToken {
    ...
    NSString *pkTokenString = [self stringWithDeviceToken:_pushKitToken];
    [[NSUserDefaults standardUserDefaults] setValue:pkTokenString forKey:@"tribuPushKitToken"];
    [[NSUserDefaults standardUserDefaults] synchronize];
    
    NSLog(@"== token: %@", pkTokenString);
...
- (void)setRemoteNotificationToken:(NSData *)remoteNotificationToken {
    ...
    NSString *tokenString = [self stringWithDeviceToken:_remoteNotificationToken];
    [[NSUserDefaults standardUserDefaults] setValue:tokenString forKey:@"tribuPushToken"];
    [[NSUserDefaults standardUserDefaults] synchronize];
